...
/* =====================================================================
   HOME HERO SLIDESHOW - REMOVED 2026-09-09 (Fahad: remove the living-room
   picture, "drop to a single static hero"). The hero is one photograph
   again, so the crossfade timer, the dot controls and the ZEF.heroSlides
   hook are all gone rather than left dormant behind their own
   `slides.length < 2` guard. The entrance animation is NOT part of this:
   `zefSettle` lives in site.css on `.slide.is-on img` and still runs.
   The removed block is recoverable from this commit's parent.
   ===================================================================== */
